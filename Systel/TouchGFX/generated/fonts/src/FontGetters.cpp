...
touchgfx::InternalFlashFont& getFont_verdana_20_4bpp()
{
    static touchgfx::InternalFlashFont verdana_20_4bpp(glyphs_verdana_20_4bpp, 17, 20, 4, 4, 0, 0, unicodes_verdana_20_4bpp, kerning_verdana_20_4bpp, 63, 0);
    return verdana_20_4bpp;
}

// verdana_32_4bpp
extern const touchgfx::GlyphNode glyphs_verdana_32_4bpp[];
extern const uint8_t unicodes_verdana_32_4bpp[];
extern const touchgfx::KerningNode kerning_verdana_32_4bpp[];
touchgfx::InternalFlashFont& getFont_verdana_32_4bpp();

touchgfx::InternalFlashFont& getFont_verdana_32_4bpp()
{
    static touchgfx::InternalFlashFont verdana_32_4bpp(glyphs_verdana_32_4bpp, 14, 32, 6, 4, 0, 0, unicodes_verdana_32_4bpp, kerning_verdana_32_4bpp, 63, 0);
